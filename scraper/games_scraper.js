    ...
    if (urlData.url !== undefined) {
      ...
      if (prospect.league === "OHL" || prospect.league === "WHL") {
        ...
        if (yesterdaysGameUSHL.length > 0) {
          const goals =
            yesterdaysGameUSHL[0].row.goals === "-"
              ? 0
              : +yesterdaysGameUSHL[0].row.goals;
          const assists =
            yesterdaysGameUSHL[0].row.assists === "-"
              ? 0
              : +yesterdaysGameUSHL[0].row.assists;
          const points =
            yesterdaysGameUSHL[0].row.points === "-"
              ? 0
              : +yesterdaysGameUSHL[0].row.points;
          const shots =
            yesterdaysGameUSHL[0].row.shots === "-"
              ? 0
              : +yesterdaysGameUSHL[0].row.shots;
          const penaltyMinutes =
            yesterdaysGameUSHL[0].row.penalty_minutes === "-"
              ? 0
              : +yesterdaysGameUSHL[0].row.penalty_minutes;
